...
$string['content_type_home'] = 'on the homepage';
$string['content_type_footer'] = 'in the footer';
$string['content_type'] = 'Type of content you wish to {$a}';
$string['content_type_desc'] = 'Select the type of content you wish to display {$a}.';
$string['content_type_default'] = 'Moodle Default';
$string['content_type_html'] = 'HTML content generated by the editor';

$string['editor_link_home'] = '<a class="btn btn-info" href="{$a}">Edit Home HTML</a>';
$string['editor_link_footer'] = '<a class="btn btn-info" href="{$a}">Edit Footer HTML</a>';
