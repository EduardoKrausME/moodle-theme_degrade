...
$string['accessibilityreport_category_description'] = 'Reports provided by theme degrade.';
...
$string['accessibilityreport_description'] = 'theme_degrade report with VLibras clicks, accessibility toolbar openings, and resource activation/deactivation.';
...
$string['background_color_brasil'] = 'Brazil theme {$a}';
$string['background_color_default'] = 'Default theme {$a}';
$string['background_color_desc'] = 'Select the background color theme.';
...
$string['background_text_color'] = 'Background text color';
$string['background_text_color_desc'] = 'Select the text color used over the background.';
$string['backgroundimage'] = 'Background image';
$string['backgroundimage_desc'] = 'The image to display as a background of the site. The background image you upload here will override the background image in your theme preset files.';
$string['brandcolor'] = 'Primary interface color';
$string['brandcolor_angle'] = 'Highlight color angle';
$string['brandcolor_angle_desc'] = 'Defines the rotation angle of the menu background gradient.';
...
$string['brandcolor_gradient_1'] = 'Primary gradient color';
$string['brandcolor_gradient_2'] = 'Secondary gradient color';
$string['brandcolor_gradient_2_desc'] = 'Set the primary and secondary gradient colors using the selector above or by choosing from the palette below.';
...
$string['privacy:metadata:theme_degrade_accesslog'] = 'Stores clicks and state changes in the theme accessibility tools.';
$string['privacy:metadata:theme_degrade_accesslog:action'] = 'The type of accessibility interaction.';
$string['privacy:metadata:theme_degrade_accesslog:activeitems'] = 'The active accessibility items after the interaction.';
$string['privacy:metadata:theme_degrade_accesslog:cmid'] = 'The course module detected when the interaction happened.';
$string['privacy:metadata:theme_degrade_accesslog:courseid'] = 'The course detected when the interaction happened.';
$string['privacy:metadata:theme_degrade_accesslog:item'] = 'The accessibility item that was clicked or changed.';
$string['privacy:metadata:theme_degrade_accesslog:pageurl'] = 'The page where the interaction happened.';
$string['privacy:metadata:theme_degrade_accesslog:statejson'] = 'The browser accessibility state after the interaction.';
$string['privacy:metadata:theme_degrade_accesslog:status'] = 'The resulting status after the interaction.';
$string['privacy:metadata:theme_degrade_accesslog:timecreated'] = 'The time when the interaction happened.';
$string['privacy:metadata:theme_degrade_accesslog:userid'] = 'The user who interacted with the accessibility tool.';
...
<div class="card-body"><a href="{$a}">Access the Quick Start Guide</a> and use the intuitive configurator to customize these and other settings of the Degrade theme.</div>
</div>';
