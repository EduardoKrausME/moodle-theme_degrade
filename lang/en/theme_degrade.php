...
$string['acctoolbar_btn_close'] = '&#10007; close';
$string['acctoolbar_btn_bright'] = 'bright<br>contrast';
$string['acctoolbar_btn_cursor_white'] = 'big white<br>cursor';
$string['acctoolbar_btn_cursor_black'] = 'big black<br>cursor';
$string['acctoolbar_btn_font_up'] = 'increase<br>text';
$string['acctoolbar_btn_font_down'] = 'decrease<br>text';
$string['acctoolbar_btn_font_readable'] = 'readable<br>text';
$string['acctoolbar_btn_images_titles'] = 'images<br>titles';
$string['acctoolbar_btn_invert'] = 'reverse<br>contrast';
$string['acctoolbar_btn_monochrome'] = 'uncolored<br>display';
$string['acctoolbar_btn_underline_links'] = 'underline<br>links';
...
$string['progress_percentage'] = 'Your progress';
...
$string['settings_icons_select_icon'] = 'Upload the custom icon.';
