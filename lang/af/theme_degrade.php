...
$string['acessar'] = 'Toegang tot Kursus';
...
$string['customcss_desc'] = 'Enige CSS-reëls wat jy by hierdie teksarea voeg, sal weerspieël word op alle bladsye, wat dit makliker maak om hierdie tema aan te pas.';
$string['fontfamily'] = 'Webwerflettertipe';
$string['fontfamily_desc'] = 'Kies watter lettertipe jy wil gebruik in jou Moodle';

$string['theme_color'] = 'Kleurkeuse';
$string['theme_color_desc'] = 'Kies die kleure van die teks en knoppies van Moodle of klik op die lyn hieronder:';
$string['theme_color_blue'] = 'Blou';
$string['theme_color_violet'] = 'Pienk';
$string['theme_color_red_d'] = 'Rooi';
...
$string['theme_color-color_titles_desc'] = 'Die gebruikte kleur vir die titels, wat beklemtoon en visuele struktuur aan die inhoud van die bladsy gee.';

$string['background_color'] = 'Agtergrondkleur';
$string['background_color_desc'] = 'Agtergrondkleur van die Bander en Voet!';
...
$string['background_color_random'] = 'Willekeurige tema {$a}';
