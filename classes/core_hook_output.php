    ...
    public static function before_footer_html_generation() {
        ...
        if (get_config("theme_degrade", "enable_accessibility")) {
            $PAGE->requires->strings_for_js([
                ...
                "acctoolbar_disable_animattions", "acctoolbar_access_declaration", "acctoolbar_debug_contacts",
                "acctoolbar_reset_all_settings", "acctoolbar_image_without_alt", "acctoolbar_contrast_block_header",
                "acctoolbar_btn_monochrome", "acctoolbar_btn_bright", "acctoolbar_btn_invert",
                "acctoolbar_text_block_header", "acctoolbar_btn_font_up", "acctoolbar_btn_font_down",
                "acctoolbar_btn_font_readable", "acctoolbar_content_block_header", "acctoolbar_btn_underline_links",
                "acctoolbar_btn_underline_headers", "acctoolbar_btn_images_titles", "acctoolbar_zoom_block_header",
                "acctoolbar_btn_cursor_white", "acctoolbar_btn_cursor_black", "acctoolbar_btn_zoom_in",
            ], "theme_degrade");
