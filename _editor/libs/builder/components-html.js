...
Vvveb.Components.extend("_base", "html/video", {
    nodes: ["video"],
    name: "Video",
    html: `<video width="320" height="240" playsinline loop autoplay muted src="${wwwroot}/theme/degrade/_editor/media/demo/sample.webm" poster="${wwwroot}/theme/degrade/_editor/media/sample.webp"><video>`,
