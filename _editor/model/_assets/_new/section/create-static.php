...
$folderName = preg_replace("/[^-a-zA-Z0-9\s]/", "", trim($moduleTitle));
$folderName = preg_replace("/\s+/", "-", $moduleTitle);
$folderName = strtolower($folderName);
$langName = str_replace("-", "_", $folderName);
...
$files = ["editor.html", "editor-plugin.js", "info.json", "print.png", "style.scss"];
...
$stringlang ="\$stringlang['{$langName}'] = '{$moduleTitle}';\n";
