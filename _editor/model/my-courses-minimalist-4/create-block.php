 ...
 * @return string
 */
function my_courses_minimalist_4_createblocks($page) {
    global $USER, $CFG;
    ...
    foreach ($courses as $course) {
        $backgroundimage = my_courses_minimalist_4_couse_image(new core_course_list_element($course));
        $progress = my_courses_minimalist_4_course_progress($course);
        $blocks .= "
...
function my_courses_minimalist_4_course_progress($course) {
    global $USER;
...
function my_courses_minimalist_4_couse_image(core_course_list_element $course) {
    global $CFG, $OUTPUT;
